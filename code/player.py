...
'Theseus_right.png')
image_path2 = os.path.join(script_dir, 'graphics',
'Theseus_left.png')
image_path3 = os.path.join(script_dir, 'graphics',
'Theseus_up.png')
image_path4 = os.path.join(script_dir, 'graphics',
'Theseus_down.png')
file_path = os.path.join('code', 'endcredits.py')
        ...
        if direction == 'horizontal':
            ...
            for sprite in self.portal_sprites:
                        if sprite.hitbox.colliderect(self.hitbox):
                            ...
                            os.system(file_path)# zazenem datoteko endcredits. 
                            pygame.quit() # zaprem pygame display window
                            sys.exit()
